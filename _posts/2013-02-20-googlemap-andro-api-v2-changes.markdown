...
![BasicMap](https://blog.amay0777.net/assets/images/posts/gmap2_basic.png)
...
![UISettings](https://blog.amay0777.net/assets/images/posts/gmap2_uisettings.png)
...
### マーカー表示
![Markers](https://blog.amay0777.net/assets/images/posts/gmap2_markers.png)
...
### 図形(ラインとかポリゴンとか)描画
![Polygons](https://blog.amay0777.net/assets/images/posts/gmap2_polygons.png)
...
![TileOverlay](https://blog.amay0777.net/assets/images/posts/gmap2_tileoverlay.png)

グラウンドオーバーレイは、画像ファイルに位置情報を与えてやると、それが地面に張り付いたように表示されるというものです。
![GroundOverlay](https://blog.amay0777.net/assets/images/posts/gmap2_groudoverlay.png)
...
![HexRinger](https://blog.amay0777.net/assets/images/posts/gmap2_hexringer.png)
