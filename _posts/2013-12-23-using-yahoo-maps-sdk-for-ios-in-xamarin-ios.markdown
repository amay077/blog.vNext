...
![](/assets/images/posts/using_ymapsdk_on_xamarin_ios_01.png)
...
![](/assets/images/posts/using_ymapsdk_on_xamarin_ios_02.png)

Xamarin Studio で、YMapBinding プロジェクトに ``libYMapKit.a`` を追加します。

![](/assets/images/posts/using_ymapsdk_on_xamarin_ios_03.png)
...
![](/assets/images/posts/using_ymapsdk_on_xamarin_ios_04.png)

YMapApp プロジェクトを右クリックして、スタートアッププロジェクトをこちらに変更しておきます。

次に、参照設定で YMapBinding を追加します。

![](/assets/images/posts/using_ymapsdk_on_xamarin_ios_05.png)
...
![](/assets/images/posts/using_ymapsdk_on_xamarin_ios_06.gif)
