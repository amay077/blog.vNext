...
![img1](/assets/images/posts/android_flat_button_sample_01.png)

### 押した時

![img1](/assets/images/posts/android_flat_button_sample_02.png)

## 仕組み

``<layer-list>`` タグの中の要素は、上から順に描画される。また、下位(手前)の要素は、上位(奥)の要素の入れ子になるみたい。

![img1](/assets/images/posts/android_flat_button_sample_03.png)
...
みんなの大好きな方眼紙EXCEL とオートシェイプで再現してみた → [DL](/assets/images/posts/flat_panel.xlsx)
